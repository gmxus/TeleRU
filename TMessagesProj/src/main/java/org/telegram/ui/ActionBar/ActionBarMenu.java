...
public class ActionBarMenu extends LinearLayout
{
    ...
    protected void updateItemsBackgroundColor()
    {
        ...
        for (int a = 0; a < count; a++)
        {
            ...
            {
                view.setBackgroundDrawable(Theme.createSelectorDrawable(isActionMode ?
                        parentActionBar.itemsActionModeBackgroundColor :
                        parentActionBar.itemsBackgroundColor));
            }
        }
    }
    ...
    protected void updateItemsColor()
    {
        ...
        for (int a = 0; a < count; a++)
        {
            ...
            if (view instanceof ActionBarMenuItem)
            {
                ((ActionBarMenuItem) view).setIconColor(isActionMode ?
                        parentActionBar.itemsActionModeColor :
                        parentActionBar.itemsColor);
            }
        }
    }
