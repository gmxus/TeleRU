        ...
        if(frame != null && frame.getChildCount() > 1) {
            ...
            if(tv != null){
                ...
                if(count > 0 && !Theme.plusHideTabsCounters){
                    ...
                    tv.getBackground().setColorFilter(allMuted ? Theme.getColor(Theme.key_chats_unreadCounterMuted) : Theme.getColor(Theme.key_chats_unreadCounter), PorterDuff.Mode.SRC_IN);
                } else{
