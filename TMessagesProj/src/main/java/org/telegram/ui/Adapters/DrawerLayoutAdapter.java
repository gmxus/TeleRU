...
public class DrawerLayoutAdapter extends RecyclerListView.SelectionAdapter
{
    ...
    private void resetItems()
    {
        ...
        // items.add(new Item(12, LocaleController.getString("ConnectedDevices", R.string.ConnectedDevices), R.drawable.connected_devices));
        // items.add(new Item(13, LocaleController.getString("ChatsCounters", R.string.ChatsCounters), R.drawable.profile_list));
        items.add(new Item(14, LocaleController.getString("ExportChat", R.string.ExportChat), R.drawable.ic_save));
    ...
    private class Item
    {
        ...
        void bind(DrawerActionCell actionCell)
        {
