    ...
    public void onFragmentDestroy()
    {
        ...
        if (player)
        {
            if (MediaController.getInstance().getPlayingMessageObject() != null)
                NotificationCenter.getInstance().postNotificationName(NotificationCenter.messagePlayingPlayStateChanged, MediaController.getInstance().getPlayingMessageObject().getId());
        }
        if (drawer)
        {
