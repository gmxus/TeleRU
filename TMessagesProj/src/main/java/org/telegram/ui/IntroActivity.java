...
public class IntroActivity extends Activity implements NotificationCenter.NotificationCenterDelegate
{
    private class BottomPagesView extends View
    {
        ...
        protected void onDraw(Canvas canvas)
        {
            ...
            paint.setColor(Color.parseColor("#2a9ad0")); // 0xff2ca5e0
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        frameLayout.setBackgroundColor(Color.parseColor("#2ca7c4")); // 0xffffffff
    ...
    private void checkContinueText()
    {
        ...
        ConnectionsManager.getInstance().sendRequest(req, (response, error) ->
        {
            if (response != null)
            {
                ...
                {
                    AndroidUtilities.runOnUIThread(() -> textView.setText(string.value));
                }
            }
    ...
    private class IntroAdapter extends PagerAdapter
    {
        ...
        public Object instantiateItem(ViewGroup container, int position)
        {
            ...
            headerTextView.setTextColor(0xffffffff);//0xff212121
            ...
            messageTextView.setTextColor(Color.parseColor("#ededed")); // 0xff808080
    ...
    public class EGLThread extends DispatchQueue
    {
        ...
        private boolean initGL()
        {
            ...
            loadTexture(R.drawable.intro_tt_plane, 21);
            loadTexture(R.drawable.intro_tt_sphere, 22);
