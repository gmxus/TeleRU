        ...
        PhotoViewer.PhotoViewerProvider
{
    ...
    public boolean onFragmentCreate()
    {
        ...
        avatarUpdater.delegate = (file, small, big) ->
        {
        ...
        versionRow = Theme.plusMoveVersionToSettings ? rowCount++ : -1;
    ...
    public View createView(Context context)
    {
        ...
        actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick()
        {
            ...
            public void onItemClick(int id)
            {
                ...
                else if (id == logout)
                {
                    ...
                    builder.setPositiveButton(LocaleController.getString("OK", R.string.OK), (dialogInterface, i) -> MessagesController.getInstance().performLogout(true));
        ...
        ActionBarMenuItem item = menu.addItem(0, /*R.drawable.ic_ab_other*/ other);
        ...
        listView.setOnItemClickListener((view, position) ->
        {
            ...
            else if (position == switchBackendButtonRow)
            {
                ...
                builder.setTitle(LocaleController.getString("AppName", R.string.AppName));
                builder.setPositiveButton(LocaleController.getString("OK", R.string.OK), (dialogInterface, i) -> ConnectionsManager.getInstance().switchBackend());
                builder.setNegativeButton(LocaleController.getString("Cancel", R.string.Cancel), null);
                showDialog(builder.create());
            }
                ...
                else if (position == bioRow)
                {
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable()
                    {
                        ...
                        public void run()
                        {
                            if (getParentActivity() != null)
                            {
                                Toast toast = Toast.makeText(getParentActivity(), "Show emoji button: " + showEmojiBtn + "\n" + "¯\\_(ツ)_/¯", Toast.LENGTH_SHORT);
                                toast.show();
                            }
                        }
                    });
        ...
        //
        SharedPreferences themePrefs = ApplicationLoader.applicationContext.getSharedPreferences(AndroidUtilities.THEME_PREFS, AndroidUtilities.THEME_PREFS_MODE);
        int gColor = themePrefs.getInt("prefTitleColor", 0xff737373);
    ...
    private void updateUserData()
    {
        ...
        avatarDrawable.setRadius(AndroidUtilities.dp(Theme.prefAvatarRadius));
        if (avatarImage != null)
        {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position)
        {
            switch (holder.getItemViewType())
            {
                ...
                case 2:
                {
                    ...
                    {
                        textCell.setText(LocaleController.getString("ClearLogs", R.string.ClearLogs), true);
                    }
                    else if (position == askQuestionRow)
                    {
