    ...
    public void onChannelOpened(final Channel ch)
    {
        ...
        try
        {
            if ("/getCurrentUser".equals(path))
            {
                ...
                if (UserConfig.isClientActivated())
                {
                    ...
                    if (user.photo != null)
                    {
                        ...
                        if (!photo.exists())
                        {
                            final NotificationCenter.NotificationCenterDelegate listener = (id, args) -> {
                            ...
                            AndroidUtilities.runOnUIThread(() -> NotificationCenter.getInstance().removeObserver(listener, NotificationCenter.FileDidLoaded));
                        }
            ...
            else if ("/waitForAuthCode".equals(path))
            {
                ...
                AndroidUtilities.runOnUIThread(() -> NotificationCenter.getInstance().addObserver(listener, NotificationCenter.didReceivedNewMessages));
                try
                {
                ...
                AndroidUtilities.runOnUIThread(() -> NotificationCenter.getInstance().removeObserver(listener, NotificationCenter.didReceivedNewMessages));
